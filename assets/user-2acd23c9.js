import{s as e,B as n}from"./svg-sprites-virtual-module-d0efe676.js";const o=new n({id:"icon-user",content:`<symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="icon-user"><g>
            ...
            </g></symbol>`,viewBox:"0 0 24 24"});e.add(o);var t=function(){var r=this,s=r._self._c;return s("svg",[s("use",{attrs:{"xlink:href":"#icon-user"}})])};const v={render:t};export{v as default};
