var c=Object.defineProperty;var n=Object.getOwnPropertySymbols;var l=Object.prototype.hasOwnProperty,p=Object.prototype.propertyIsEnumerable;var i=(t,o,e)=>o in t?c(t,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[o]=e,a=(t,o)=>{for(var e in o||(o={}))l.call(o,e)&&i(t,e,o[e]);if(n)for(var e of n(o))p.call(o,e)&&i(t,e,o[e]);return t};import{m,n as h}from"./index-ca38caf2.js";import{g as x}from"./LangUtils-019ecd1f.js";import{D as g}from"./DocCodeView-1577d605.js";const r=`import React, { useEffect, useRef } from 'react';
...
export default SimpleGraph;`,s=`import React, { useEffect, useRef } from 'react';
import RelationGraph, {RelationGraphInstance} from 'relation-graph/react';
import type { MutableRefObject} from 'react';
import type {
  RGLine,
...
export default SimpleGraph;`;var f=function(){var t=this,o=t.$createElement,e=t._self._c||o;return e("div",{staticStyle:{"font-size":"14px"}},[e("h3",[t._v("React：")]),e("div",{staticClass:"c-rgc-code"},[e("div",[t._v("npm install --save relation-graph-react")]),e("div",{staticClass:"c-rgc-comment"},[t._v(" "+t._s(t.getTextByLang(t.english,["// 注意：使用时import的方式与vue2不一样：import RelationGraph from 'relation-graph-react'","// Note: The import method is different from Vue2 when using it: import RelationGraph from 'relation-graph-react'"]))+" ")])]),e("DocCodeView",{attrs:{mode:"text/jsx",height:"700px",code:t.demoCode}}),e("div",{staticStyle:{"padding-top":"30px","padding-bottom":"30px"}},[t._v(" "+t._s(t.getTextByLang(t.english,["更多示例：","More examples"]))+" "),e("el-link",{staticStyle:{color:"#337ab7"},attrs:{href:"#/demo",target:"_blank"}},[t._v(" "+t._s(t.getTextByLang(t.english,["在线demo","Examples online"]))+" ")])],1),e("div",{staticStyle:{"padding-top":"10px","padding-bottom":"10px"}},[t._v(" "+t._s(t.getTextByLang(t.english,["完整的、可运行的示例react项目(Typescript)：","A complete, runnable React project example(Typescript):.. "]))+" "),e("el-link",{staticStyle:{color:"#337ab7"},attrs:{href:"https://github.com/seeksdream/relation-graph-react-demo",target:"_blank"}},[t._v(" https://github.com/seeksdream/relation-graph-react-demo ")])],1),e("div",{staticClass:"c-rgc-code"},[e("div",{staticClass:"c-rgc-comment"},[t._v(" "+t._s(t.getTextByLang(t.english,["// 通过以下几行命令，快速下载并启动示例：","// With the following lines of commands, you can quickly download and start the example: "]))+" ")]),e("div",[t._v("git clone https://github.com/seeksdream/relation-graph-react-demo")]),e("div",[t._v("cd relation-graph-react-demo")]),e("div",[t._v("npm install")]),e("div",[t._v("npm run dev")]),e("div",{staticClass:"c-rgc-comment"},[t._v(" "+t._s(t.getTextByLang(t.english,["访问终端中显示的地址在你的浏览器中查看示例","Visit the address displayed in the terminal and view the example in your browser."]))+" ")])]),e("div",{staticStyle:{"padding-top":"10px","padding-bottom":"10px"}},[t._v("Github："),e("el-link",{staticStyle:{color:"#337ab7"},attrs:{href:"https://github.com/seeksdream/relation-graph",target:"_blank"}},[t._v("https://github.com/seeksdream/relation-graph")])],1)],1)},u=[];const y={name:"NodeAttributes",components:{DocCodeView:g},data(){return{checkedRoute:null,demoCode:"",codeString:""}},computed:a({},m(["english"])),watch:{english(){this.demoCode=this.english?s:r}},mounted(){this.demoCode=this.english?s:r},methods:{getTextByLang:x}},d={};var v=h(y,f,u,!1,R,null,null,null);function R(t){for(let o in d)this[o]=d[o]}const _=function(){return v.exports}();export{_ as default};
