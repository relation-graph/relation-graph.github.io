function G(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var j={exports:{}},h={};/**
 * @license React
 ...
 */var $;function J(){if($)return h;$=1;var r=Symbol.for("react.element"),m=Symbol.for("react.portal"),z=Symbol.for("react.fragment"),Z=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),O=Symbol.for("react.provider"),P=Symbol.for("react.context"),I=Symbol.for("react.forward_ref"),T=Symbol.for("react.suspense"),D=Symbol.for("react.memo"),F=Symbol.for("react.lazy"),f=Symbol.iterator;function U(c){return c===null||typeof c!="object"?null:(c=f&&c[f]||c["@@iterator"],typeof c=="function"?c:null)}var y={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},S=Object.assign,x={};function s(c,a,l){this.props=c,this.context=a,this.refs=x,this.updater=l||y}s.prototype.isReactComponent={},s.prototype.setState=function(c,a){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,a,"setState")},s.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function b(){}b.prototype=s.prototype;function u(c,a,l){this.props=c,this.context=a,this.refs=x,this.updater=l||y}var A=u.prototype=new b;A.constructor=u,S(A,s.prototype),A.isPureReactComponent=!0;var k=Array.isArray,w=Object.prototype.hasOwnProperty,C={current:null},q={key:!0,ref:!0,__self:!0,__source:!0};function E(c,a,l){var e,t={},M=null,n=null;if(a!=null)for(e in a.ref!==void 0&&(n=a.ref),a.key!==void 0&&(M=""+a.key),a)w.call(a,e)&&!q.hasOwnProperty(e)&&(t[e]=a[e]);var g=arguments.length-2;if(g===1)t.children=l;else if(1<g){for(var v=Array(g),d=0;d<g;d++)v[d]=arguments[d+2];t.children=v}if(c&&c.defaultProps)for(e in g=c.defaultProps,g)t[e]===void 0&&(t[e]=g[e]);return{$$typeof:r,type:c,key:M,ref:n,props:t,_owner:C.current}}function B(c,a){return{$$typeof:r,type:c.type,key:a,ref:c.ref,props:c.props,_owner:c._owner}}function _(c){return typeof c=="object"&&c!==null&&c.$$typeof===r}function N(c){var a={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(l){return a[l]})}var R=/\/+/g;function L(c,a){return typeof c=="object"&&c!==null&&c.key!=null?N(""+c.key):a.toString(36)}function H(c,a,l,e,t){var M=typeof c;(M==="undefined"||M==="boolean")&&(c=null);var n=!1;if(c===null)n=!0;else switch(M){case"string":case"number":n=!0;break;case"object":switch(c.$$typeof){case r:case m:n=!0}}if(n)return n=c,t=t(n),c=e===""?"."+L(n,0):e,k(t)?(l="",c!=null&&(l=c.replace(R,"$&/")+"/"),H(t,a,l,"",function(d){return d})):t!=null&&(_(t)&&(t=B(t,l+(!t.key||n&&n.key===t.key?"":(""+t.key).replace(R,"$&/")+"/")+c)),a.push(t)),1;if(n=0,e=e===""?".":e+":",k(c))for(var g=0;g<c.length;g++){M=c[g];var v=e+L(M,g);n+=H(M,a,l,v,t)}else if(v=U(c),typeof v=="function")for(c=v.call(c),g=0;!(M=c.next()).done;)M=M.value,v=e+L(M,g++),n+=H(M,a,l,v,t);else if(M==="object")throw a=String(c),Error("Objects are not valid as a React child (found: "+(a==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":a)+"). If you meant to render a collection of children, use an array instead.");return n}function V(c,a,l){if(c==null)return c;var e=[],t=0;return H(c,e,"","",function(M){return a.call(l,M,t++)}),e}function K(c){if(c._status===-1){var a=c._result;a=a(),a.then(function(l){(c._status===0||c._status===-1)&&(c._status=1,c._result=l)},function(l){(c._status===0||c._status===-1)&&(c._status=2,c._result=l)}),c._status===-1&&(c._status=0,c._result=a)}if(c._status===1)return c._result.default;throw c._result}var p={current:null},o={transition:null},W={ReactCurrentDispatcher:p,ReactCurrentBatchConfig:o,ReactCurrentOwner:C};return h.Children={map:V,forEach:function(c,a,l){V(c,function(){a.apply(this,arguments)},l)},count:function(c){var a=0;return V(c,function(){a++}),a},toArray:function(c){return V(c,function(a){return a})||[]},only:function(c){if(!_(c))throw Error("React.Children.only expected to receive a single React element child.");return c}},h.Component=s,h.Fragment=z,h.Profiler=i,h.PureComponent=u,h.StrictMode=Z,h.Suspense=T,h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=W,h.cloneElement=function(c,a,l){if(c==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+c+".");var e=S({},c.props),t=c.key,M=c.ref,n=c._owner;if(a!=null){if(a.ref!==void 0&&(M=a.ref,n=C.current),a.key!==void 0&&(t=""+a.key),c.type&&c.type.defaultProps)var g=c.type.defaultProps;for(v in a)w.call(a,v)&&!q.hasOwnProperty(v)&&(e[v]=a[v]===void 0&&g!==void 0?g[v]:a[v])}var v=arguments.length-2;if(v===1)e.children=l;else if(1<v){g=Array(v);for(var d=0;d<v;d++)g[d]=arguments[d+2];e.children=g}return{$$typeof:r,type:c.type,key:t,ref:M,props:e,_owner:n}},h.createContext=function(c){return c={$$typeof:P,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},c.Provider={$$typeof:O,_context:c},c.Consumer=c},h.createElement=E,h.createFactory=function(c){var a=E.bind(null,c);return a.type=c,a},h.createRef=function(){return{current:null}},h.forwardRef=function(c){return{$$typeof:I,render:c}},h.isValidElement=_,h.lazy=function(c){return{$$typeof:F,_payload:{_status:-1,_result:c},_init:K}},h.memo=function(c,a){return{$$typeof:D,type:c,compare:a===void 0?null:a}},h.startTransition=function(c){var a=o.transition;o.transition={};try{c()}finally{o.transition=a}},h.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")},h.useCallback=function(c,a){return p.current.useCallback(c,a)},h.useContext=function(c){return p.current.useContext(c)},h.useDebugValue=function(){},h.useDeferredValue=function(c){return p.current.useDeferredValue(c)},h.useEffect=function(c,a){return p.current.useEffect(c,a)},h.useId=function(){return p.current.useId()},h.useImperativeHandle=function(c,a,l){return p.current.useImperativeHandle(c,a,l)},h.useInsertionEffect=function(c,a){return p.current.useInsertionEffect(c,a)},h.useLayoutEffect=function(c,a){return p.current.useLayoutEffect(c,a)},h.useMemo=function(c,a){return p.current.useMemo(c,a)},h.useReducer=function(c,a,l){return p.current.useReducer(c,a,l)},h.useRef=function(c){return p.current.useRef(c)},h.useState=function(c){return p.current.useState(c)},h.useSyncExternalStore=function(c,a,l){return p.current.useSyncExternalStore(c,a,l)},h.useTransition=function(){return p.current.useTransition()},h.version="18.1.0",h}(function(r){r.exports=J()})(j);var Q=G(j.exports);const Y=[{name:"airport_Sign_1",svg:`<g>
        ...
        <path  d="M3.063,18.437V5.563a2.5,2.5,0,0,1,2.5-2.5H18.437a2.5,2.5,0,0,1,2.5,2.5V18.437a2.5,2.5,0,0,1-2.5,2.5H5.563A2.5,2.5,0,0,1,3.063,18.437ZM19.937,5.563a1.5,1.5,0,0,0-1.5-1.5H5.563a1.5,1.5,0,0,0-1.5,1.5V18.437a1.5,1.5,0,0,0,1.5,1.5H18.437a1.5,1.5,0,0,0,1.5-1.5Z"/>
            ...
            </g>`}],X=({name:r,size:m,color:z,displayIcon:Z})=>(Z=Y.find(i=>i.name===r),Q.createElement("svg",{class:"circumicon__"+r,width:m,height:m,viewBox:"0 0 24 24",fill:z,dangerouslySetInnerHTML:{__html:Z.svg}}));X.defaultProps={size:"32px",color:"currentColor"};export{X as I};
